...
bool Coll::check_collision(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
...
bool Coll::check_grounded(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
...
bool Coll::check_up_collision(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
...
bool Coll::check_down_collision(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
...
bool Coll::check_left_collision(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
...
bool Coll::check_right_collision(SDL_Rect &box, std::vector<Enemy_Unit> &enemySet, SDL_Rect &posOffset){
	for(int i = 0; i < enemySet.size(); i++){
		SDL_Rect temp = enemySet[i].get_box();
